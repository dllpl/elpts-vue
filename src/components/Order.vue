          ...
          >
                    ...
                    <div class="form__item">
                      ...
                      <div class="form__input">
                        <validation-provider
                            ...
                            rules="required"
                        >
                          <input class="input" type="text" name="family" placeholder="Фамилия" required
                                 v-model="last_name">
                        ...
                        <validation-provider
                            ...
                            rules="required"
                        >
                          <input class="input" type="text" name="name" placeholder="Имя" v-model="first_name" required>
                          <p style="color:red">{{ errors[0] }}</p>
                        </validation-provider>
                        <validation-provider
                            v-slot="{ errors }"
                      ...
                      <div class="form__input">
                        ...
                        >
                          <input class="input" type="text" name="city"
                                 placeholder="Населенный пункт" v-model="city" required>
                          <p style="color:red">{{ errors[0] }}</p>
                        </validation-provider>
                        <validation-provider
                            v-slot="{ errors }"
                  ...
                  <div class="form__right">
                    ...
                    <div style="display: flex;">
                      <validation-provider
                          ...
                          :rules="{ required}"
                      >
                        <input type="checkbox" @click="checkbox=true" v-model="checkbox">
                        <p style="color:red">{{ errors[0] }}</p>
                      </validation-provider>
                      <p>Даю согласие на&nbsp;обработку персональных данных, соглашаюсь с <a href="#"
                                                                                             target="_blank">
                ...
                <div class="form__center">
                  ...
                  <div class="form__left">
                    <div class="form__item">
                      ...
                      <div class="">
                        <input class="input" type="text" name="name" placeholder="Название организации"
                               v-model="org_name">
                      </div>
                    </div>
                    ...
                    <div class="form__item">
                      ...
                      <div class="form__input">
                        <input class="input input--s" type="text" name="city"
                               placeholder="Населенный пункт" v-model="city">
                        <input class="input input--s" type="text" name="street" placeholder="Улица"
                               v-model="street">
                        <input class="input input--s" type="text" name="house" placeholder="Дом"
                               v-model="home">
                        <input class="input input--s" type="text" name="flat" placeholder="Квартира"
                               v-model="flat">
                      </div>
                    </div>
                    ...
                    <div class="form__item">
                      <h3 class="form__name title">Контактная информация</h3>
                      <div class="form__input">
                        <input class="input input--s" type="text" name="phone" placeholder="Телефон"
                               v-model="phone">
                        <input class="input input--s" type="text" name="mail" placeholder="Эл. почта"
                               v-model="email">
                      </div>
                    </div>
                  </div>
                  <div class="form__right">
                    <div class="form__item">
                      ...
                      <div class="">
                        <input class="input" type="text" name="inn" placeholder="ИНН" v-model="inn">
                        <input class="input" type="text" name="kpp" placeholder="КПП" v-model="kpp">
                        <input class="input" type="text" name="ogrn" placeholder="ОГРН" v-model="ogrn">
                      </div>
                    </div>
                  </div>
                </div>
                <div style="display: flex;">
                  <input type="checkbox" :checked="checkbox" @change="checkbox=true">
                  <p>Даю согласие на&nbsp;обработку персональных данных, соглашаюсь с <a href="#" target="_blank">
                    политикой&nbsp;конфиденциальности</a></p>
                </div>
              </div>
            </div>
            <section v-if="step>0 && step<5">
              <div class="form__bottom ">
                ...
                <button class="btn btn--next" @click="stepNext" :disabled="invalid" :class="{'disabled':invalid}">Далее
                  ›
                </button>
              </div>
            </section>
          ...
          <div class="form">
            ...
            <div class="form__top">
              <div class="form__item">
                ...
                <div class="form__input">
                  <input class="input input--l" type="text" name="brand" placeholder="Марка и модификация ТС"
                         v-model="car_mark">
            ...
            <div class="form__center">
              <div class="form__left">
                <div class="form__item">
                  ...
                  <div>
                    <input class="input" type="text" name="type" placeholder="Тип" v-model="car_type">
                  </div>
                </div>
                ...
                <div class="form__item">
                  ...
                  <div>
                    <input class="input" type="text" name="id-number" placeholder="Идентификационный номер"
                           v-model="car_id">
                  </div>
                </div>
                ...
                <div class="form__item">
                  ...
                  <div class="form__input">
                    <input class="input input--s" type="text" name="model" placeholder="Модель"
                           v-model="engine_model">
                    <input class="input input--s" type="text" name="engine-number"
              ...
              <div class="form__right">
                ...
                <div class="form__item">
                  ...
                  <div class="form__input">
                    <input class="input input--xs" type="text" name="power" placeholder="Мощность"
                           v-model="engine_power">
                    <input class="input input--xs" type="text" name="volume" placeholder="Объем"
                           v-model="engine_volume">
                    <input class="input input--xs" type="text" name="fuel" placeholder="Топливо"
                           v-model="fuel">
                  </div>
                </div>
              </div>
                ...
                <div class="form__item">
                  ...
                  <div class="">
                    <div class="input__wrapper">
                      <input type="file" class="input__file"
                             multiple>
                      <label class="input__file-button">
                        <div class="input__file-icon-wrapper">
                          <img class="input__file-icon" src="/img/file.svg" alt="Выбрать файл">
                        </div>
                        <p class="text input__file-button-text" :class="{'text--done':!sts_front}">
                          Загрузить<br>
                        ...
                        <div class="input__file-icon-wrapper done" :class="{'done--active':sts_front}">
                          <img class="input__file-icon" src="/img/icon/done.svg" alt="Выбрать файл">
                        </div>
                      </label>
                    </div>
                  </div>
                  ...
                  <form class="">
                    <div class="input__wrapper">
                      ...
                      <label class="input__file-button">
                        ...
                        <p class="text input__file-button-text" :class="{'text--done':sts_back}">
                          Загружено</p>

                        <div class="input__file-icon-wrapper done" :class="{'done--active':sts_back}">
                          <img class="input__file-icon" src="/img/icon/done.svg" alt="Выбрать файл">
                        </div>
                      </label>
                    </div>
        ...
        <section class="step-four" v-if="step === 4">
          <div class="form">
            ...
            <div class="form__pay pay">
              ...
              <ul class="pay__list">
                <li class="pay__item"><input type="radio" name="face" value="" checked>Банковской картой</li>
