        ...
        <div class="form">
          ...
          <div class="form__center">
            <div class="form__left">
              ...
              <div class="form__item">
                <h3 class="form__name title">Фото VIN на табличке/или под лобовым стеклом <span class="example__button"
    ...
    async stepNext() {
      if (this.form.step === 1) {
        if (this.form.type_owner === 1) {
          if (!await this.$refs.observer1.validate()) {
            window.scrollTo(0, 250)
            return false
          }
        } else {
          if (!await this.$refs.observer1_1.validate()) {
            window.scrollTo(0, 250)
            return false;
          }
        }
      ...
      if (this.form.step === 3) {
        if (!await this.$refs.observer3.validate()) {
