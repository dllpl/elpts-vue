                    ...
                    <li class="photo__item item-car">
                      <div class="photo__wrapper" @click="$modal.show('modal3')">
                        ...
                        <modal name="modal3"
                               ...
                               :adaptive="true"
                        >
                          <img src="img/example/ts_front.svg" alt="" width="768" height="500">
                        </modal>
                      </div>
                      <div class="photo__wrapper" @click="$modal.show('modal4')">
                        ...
                        <modal name="modal4"
                               ...
                               :adaptive="true"
                        >
                          <img src="img/example/ts_back.svg" alt="" width="768" height="500">
                        </modal>
                      </div>
                      <div class="photo__wrapper" @click="$modal.show('modal5')">
                        ...
                        <modal name="modal5"
                               ...
                               :adaptive="true"
                        >
                          <img src="img/example/ts_left.svg" alt="" width="768" height="500">
                        </modal>
                      </div>
                      <div class="photo__wrapper" @click="$modal.show('modal6')">
                        ...
                        <modal name="modal6"
                               ...
                               :adaptive="true"
                        >
                          <img src="img/example/ts_right.svg" alt="" width="768" height="500">
                        </modal>
                      </div>
                    </li>
                    <li class="photo__item " style="border-bottom: 1px solid var(--bay-leaf);">
